...
const whichUser = comments.find((comment)=> comment.text === 'OK great thanks').userId
console.log(whichUser);

const mix = users.find((user)=>
   user.id === comments.find((comment)=>
...
/* Exercise 4
  Add the user's first and last name to each element in the comments array
*/
